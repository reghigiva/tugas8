<?php
//mengambil data  inputan dari  formpesertadidik.php
include 'formpesertadidik.php';

//untuk menampilkan data yang telah kita input di formpesertadidik.php
...
//insialisasi variabel database  servername,  username, password, dbname
...
//query untuk memaasukkan ke database
